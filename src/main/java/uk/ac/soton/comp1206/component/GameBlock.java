...
public class GameBlock extends Canvas {
  ...
  /** high light a block when its hovered. */
  ...
  /** Paint a circle on the center of the grid. */
  ...
  /**
   * Set method for hover, repaint the block when is set to hover.
   *
   * @param hover
   */
  ...
  /** FadeOut method to fade out the cleaned blocks */
  public void fadeOut() {
        ...
        new AnimationTimer() {
          ...
          public void handle(long now) {
            ...
            if (fade < 0) {
              ...
              var gc = getGraphicsContext2D();
              gc.setFill(Color.color(1, 0, 1, fade));
              gc.fillRect(0, 0, width, height);
            }
          }
        };
